        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-[380px] rounded-2xl shadow-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
              ...
              <button onClick={() => setIsViewReviewModalOpen(false)} className="text-gray-400">✕</button>
            </div>
            <div className="p-8 text-center">
              ...
              <div className="flex justify-center gap-1 mb-4">
                {[1, 2, 3, 4, 5].map((star) => (
                  <span key={star} className={`text-2xl ${star <= selectedRequest.userRating ? "text-amber-400" : "text-gray-200"}`}>★</span>
                ))}
              </div>
        ...
        <div className="fixed inset-0 z-[130] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-[380px] rounded-2xl shadow-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
              ...
              <button onClick={() => setIsRateModalOpen(false)} className="text-gray-400">✕</button>
            </div>
            <div className="p-8 text-center">
              <div className="flex flex-col items-center mb-4">
                <img src={selectedRequest.image} className="w-14 h-14 rounded-lg object-cover mb-2" alt="" />
              ...
              <p className="text-[9px] text-gray-400 flex items-center justify-center gap-1">
                <span className="text-[#00AF91]">✔</span> Thank you for helping others by sharing a feedback!
              </p>
            </div>
          </div>
        </div>
      ...
      {isCancelModalOpen && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-[360px] rounded-3xl shadow-2xl p-8 text-center">
            <div className="w-14 h-14 bg-amber-50 rounded-full flex items-center justify-center mx-auto mb-3 text-3xl">⚠️</div>
