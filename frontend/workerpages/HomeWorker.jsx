    ...
    <div className="min-h-screen bg-[#F9F6F2] font-sans flex flex-col items-center overflow-x-hidden relative">
      ...
      <header className="w-full bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm">
        <div className="max-w-[1280px] mx-auto w-full px-6 py-4 flex justify-between items-center">
          <div className="w-[260px] flex items-center gap-1 text-[#00A651] font-bold text-2xl italic tracking-tighter cursor-pointer" onClick={() => navigate('/HomeWorker')}>
            Traba<span className="text-[#00A651]">Home</span>
          </div>
