    ...
    <div className="w-full min-h-screen bg-[#FDFBF7] text-[#0B3B68] overflow-x-hidden font-sans relative">
      ...
      <section className="py-16 px-6 relative">
        <div className="max-w-4xl mx-auto text-center mb-16 relative z-10">
           ...
           <p className="text-gray-500 font-medium max-w-2xl mx-auto">We built TrabaHome to protect both homeowners and workers—so every job feels safe, fair, and reliable.</p>
        </div>
