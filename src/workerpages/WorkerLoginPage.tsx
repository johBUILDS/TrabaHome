...
type WorkerSessionResponse = Awaited<ReturnType<typeof workerAPI.login>>;
...
export default function WorkerLoginPage() {
  ...
  const completeWorkerSignIn = (result: WorkerSessionResponse, fallbackEmail: string): void => {
    if (!result?.token) {
  ...
  const handleCredentialsSubmit = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
